...
import {
  ...
  ErrorResponseSchema,
  FallbackNotificationDelayResponseSchema,
  OkResponseSchema,
...
export const apiPaths = {
  ...
  setFallbackNotificationDelay: "/api/alerts/fallback-delay",
...
export const apiContract = c.router({
  ...
  setFallbackNotificationDelay: {
    method: "PUT",
    path: apiPaths.setFallbackNotificationDelay,
    body: SetFallbackNotificationDelayRequestSchema,
    responses: {
      200: FallbackNotificationDelayResponseSchema,
      ...commonErrorResponses,
    },
  },
  pullMain: {
